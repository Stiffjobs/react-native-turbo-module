...
NativeCppTurboModule::NativeCppTurboModule(std::shared_ptr<CallInvoker> jsInvoker): NativeTurboModuleCxxSpec(std::move(jsInvoker)){}
...
jsi::Value NativeCppTurboModule::promiseNumber(jsi::Runtime &rt, double number) {
    ...
    return promiseConstructor.callAsConstructor(rt, jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forAscii(rt, "promiseArg"), 2, [number] (jsi::Runtime &runtime, const jsi::Value& thisValue, const jsi::Value* arguments, std::size_t count)->jsi::Value {
